        ...
        <TabsContent value="about" className="space-y-6 animate-in fade-in">
          ...
          <div className="text-center py-6 border-t border-border/50 space-y-4">
            <div className="flex items-center justify-center gap-4">
              ...
              <a href="https://linkedin.com/in/kurutodenzeru" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/60 hover:text-foreground transition-colors" title="LinkedIn">
              ...
              <a href="https://instagram.com/kurutodenzeru" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/60 hover:text-foreground transition-colors" title="Instagram">
